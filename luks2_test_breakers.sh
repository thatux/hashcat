...
echo 0345679006880395984065151993862430373984899197156293374473453587 | ./hashcat --quiet --potfile-disable --logfile-disable -D 1 -O --runtime 400 --backend-vector-width 1 -a 0 -m 34100 '/tmp/out/luks2-aes-argon2id-t5-m128-p1-size20MiB_20250820011624.img.hash'
echo 092716992067403233252313393903721300734140880391054076903189463965468444734759793085092208358915927608346472113431131955747291957347211075230084374387836493635520801029311920288416279313090562580508654717694099523011 | ./hashcat --quiet --potfile-disable --logfile-disable -D 1 -O --runtime 400 --backend-vector-width 1 -a 0 -m 34100 '/tmp/out/luks2-aes-argon2id-t6-m32-p2-size20MiB_20250820044335.img.hash'
...
echo 1922469771464508431870616480582073688372297197898457493620148193 | ./hashcat --quiet --potfile-disable --logfile-disable -D 1 -O --runtime 400 --backend-vector-width 1 -a 0 -m 34100 '/tmp/out/luks2-aes-argon2i-t6-m64-p2-size20MiB_20250820012705.img.hash'
echo 20715796298165638929199608987398858551118249353852386788523592992442437727432073 | ./hashcat --quiet --potfile-disable --logfile-disable -D 1 -O --runtime 400 --backend-vector-width 1 -a 0 -m 34100 '/tmp/out/luks2-aes-argon2id-t5-m16-p1-size20MiB_20250820013520.img.hash'
echo 217477661849793305564605636484552327148417108403102506985107718467839335621974361380819535702532 | ./hashcat --quiet --potfile-disable --logfile-disable -D 1 -O --runtime 400 --backend-vector-width 1 -a 0 -m 34100 '/tmp/out/luks2-aes-argon2i-t6-m128-p2-size20MiB_20250820071602.img.hash'
echo 374775505382147353565438052154677880530475349648612138532046562862377075782364584606063347688030 | ./hashcat --quiet --potfile-disable --logfile-disable -D 1 -O --runtime 400 --backend-vector-width 1 -a 0 -m 34100 '/tmp/out/luks2-aes-argon2id-t4-m128-p2-size20MiB_20250820062428.img.hash'
...
echo 46077772389265887919949570209384719734401656195311380803350406753901240629193125 | ./hashcat --quiet --potfile-disable --logfile-disable -D 1 -O --runtime 400 --backend-vector-width 1 -a 0 -m 34100 '/tmp/out/luks2-aes-argon2i-t6-m16-p1-size20MiB_20250820070332.img.hash'
...
echo 6099764068910182982816969215608518920569179782649857896975804220 | ./hashcat --quiet --potfile-disable --logfile-disable -D 1 -O --runtime 400 --backend-vector-width 1 -a 0 -m 34100 '/tmp/out/luks2-aes-argon2id-t5-m128-p8-size20MiB_20250820082710.img.hash'
echo 6628256105782870142991529512339996019300535171995446617664454830176772268326017249979236 | ./hashcat --quiet --potfile-disable --logfile-disable -D 1 -O --runtime 400 --backend-vector-width 1 -a 0 -m 34100 '/tmp/out/luks2-aes-argon2id-t6-m128-p4-size20MiB_20250820053930.img.hash'
echo 78561619564772367582757348828498697051534478779324101746263617520087966732714864 | ./hashcat --quiet --potfile-disable --logfile-disable -D 1 -O --runtime 400 --backend-vector-width 1 -a 0 -m 34100 '/tmp/out/luks2-aes-argon2id-t4-m32-p8-size20MiB_20250820014704.img.hash'
# all the above don't crack

pw="78561619564772367582757348828498697051534478779324101746263617520087966732714864"
img="/tmp/out/luks2-aes-argon2id-t4-m32-p8-size20MiB_20250820014704.img"
hash=$img.hash
